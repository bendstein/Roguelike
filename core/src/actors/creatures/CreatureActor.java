...
public class CreatureActor extends Actor {
    ...
    public CreatureActor(Creature creature) {
        ...
        setBounds(creature.getX() * ApplicationMain.getTILE_SIZE(), creature.getX() * ApplicationMain.getTILE_SIZE(),
                ApplicationMain.getTILE_SIZE(), ApplicationMain.getTILE_SIZE());
    }

    @Override
    public void draw(Batch batch, float parentAlpha) {
        if(creature.getWorld().getPlayer().canSee(creature.getX(), creature.getY()))
