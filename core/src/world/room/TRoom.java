...
public class TRoom extends Room {
    ...
    public TRoom(int x, int y, int w, int h, int w1, int h1, int orientation) {
        super(x, y, w + (2 * w1), h + h1);
        this.w = w;
        this.h = h;
        this.w1 = w1;
    ...
    public TRoom(int w, int h, int w1, int h1, int orientation) {
        super(0, 0, w + (2 * w1), h + h1);
        this.w = w;
        this.h = h;
        this.w1 = w1;
        this.h1 = Math.max(h1, 1);
